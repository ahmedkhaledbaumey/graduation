...
class Student extends Authenticatable implements JWTSubject
{
    ...
    const degree = ['master', 'phd'];
    const level = ['first_level', 'second_level'];

    protected $fillable = [
        'type','status', 'idea', 'address', 'phone', 'SSN', 'name', 'english_name', 'email', 'age', 'password', 'department_id', 'time', 'nationality', 'job', 'gender', 'marital_status', 'religion', 'payment','degree'
    ];
